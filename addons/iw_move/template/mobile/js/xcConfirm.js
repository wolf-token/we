...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		function test(){
                    ...
                    data:{status:5},
                    dataTpye:"json",
                    url:"http://move.yichujilian.com/web/index.php?c=site&a=entry&op=check&do=login&m=iw_move",
                    success:function(result){
                        
                        //判断是否有数据
                        if (result == "yes") {
          
                        	var txt=  "<a href='http://move.yichujilian.com/web/index.php?c=site&a=entry&op=refuse&do=indent&m=iw_move'>您有分配失败或者未分配或者维修工拒绝接单的订单需要处理，请到报装故障订单中查看并进行处理！！！</a>";
